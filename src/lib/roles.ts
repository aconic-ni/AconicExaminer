...
export type NavLink = 'admin' | 'assignments' | 'dashboard' | 'dbPrevios' | 'dbPagos' | 'dbMemorandum' | 'dbPermisos' | 'dbValidaciones' | 'photos' | 'reportsPrevios' | 'reportsAforo' | 'agenteCasos' | 'supervisor' | 'executive' | 'reporter' | 'facturacion';
...
export const roleConfig: Record<UserRole, RoleConfig> = {
  admin: {
    home: '/admin',
    navLinks: ['admin', 'assignments', 'dashboard', 'dbPrevios', 'dbPagos', 'dbMemorandum', 'dbPermisos', 'dbValidaciones', 'photos', 'reportsPrevios', 'reportsAforo', 'facturacion'],
  },
  coordinadora: {
    home: '/executive',
    navLinks: ['assignments', 'dashboard', 'dbPrevios', 'dbPagos', 'dbMemorandum', 'dbPermisos', 'dbValidaciones', 'photos', 'reportsPrevios', 'executive', 'reporter', 'facturacion'],
  },
  supervisor: {
    home: '/supervisor',
    navLinks: ['assignments', 'dashboard', 'dbPrevios', 'dbPagos', 'dbMemorandum', 'dbPermisos', 'dbValidaciones', 'photos', 'reportsPrevios', 'reportsAforo', 'executive', 'reporter', 'facturacion'],
  },
  ejecutivo: {
    home: '/executive',
    navLinks: ['dashboard', 'dbPrevios', 'dbPagos', 'dbMemorandum', 'dbPermisos', 'photos', 'reportsPrevios', 'reportsAforo', 'executive'],
  },
  gestor: {
    home: '/examiner',
  ...
  aforador: {
    home: '/database',
    navLinks: ['dashboard', 'dbPrevios', 'photos', 'reporter'],
  },
  agente: {
    home: '/agente',
  ...
  digitador: {
    home: '/thereporter',
    navLinks: ['reportsAforo', 'photos', 'reporter'],
  },
  revisor: {
    home: '/databasePay',
