...
export type UserRole = 'gestor' | 'aforador' | 'ejecutivo' | 'coordinadora' | 'admin' | 'agente' | 'digitador' | 'supervisor' | 'revisor' | 'calificador' | 'autorevisor' | 'autorevisor_plus' | 'invitado' | 'facturador';
