...
export type UserRole = 'gestor' | 'aforador' | 'ejecutivo' | 'coordinadora' | 'admin' | 'agente' | 'digitador' | 'supervisor' | 'revisor' | 'calificador' | 'autorevisor' | 'autorevisor_plus';
...
export interface AppUser {
  ...
  visibilityGroup?: string[]; // For executive groups - stores UIDs
...
export type AforadorStatus = 'En proceso' | 'Incompleto' | 'En revisión' | 'Pendiente ';
...
export type DocumentStatus = 'Entregado' | 'En Trámite' | 'Pendiente' | 'Rechazado';
...
export interface RequiredPermit {
    ...
    assignedExecutive?: string; // New field for permit-specific assignment
}
