...
const userRoles: UserRole[] = ['admin', 'coordinadora', 'ejecutivo', 'gestor', 'aforador', 'agente', 'supervisor', 'digitador', 'revisor', 'calificador', 'autorevisor', 'autorevisor_plus', 'invitado'];
