        ...
        <TableBody>
          {displayCases.map((caseItem) => {
            ...
            const rowClass = cn(
              ...
              isResaCritical ? "bg-red-200 hover:bg-red-200/80" : (caseItem.incidentReported ? "bg-red-100 hover:bg-red-100/80" : (!caseItem.incidentReported && caseItem.aforadorStatus === 'Pendiente ' ? "bg-red-50 hover:bg-red-100/60" : ""))
            );
