...
import { FileSpreadsheet, LogOut, UserCircle, Camera, ListTodo, Database, Home, Menu, X, Shield, PieChart, Bell } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { href: '/thereporter', label: 'Aforo Reports', icon: FileSpreadsheet, roles: ['all'], requiresReportsAccess: true },
...
export function AppHeader() {
  ...
  const accessibleNavItems = navItems.filter(item => {
      ...
      // Admins see everything that isn't agent-specific
      if (user.role === 'admin') {
          return !item.isAgentSpecific;
      }
      // Handle the reporter link specifically
      if (item.requiresReportsAccess) return user.hasReportsAccess;
      // Handle general roles
