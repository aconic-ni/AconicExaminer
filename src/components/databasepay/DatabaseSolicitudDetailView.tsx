  ...
  const content = () => {
    ...
    return (
        <CardContent className="pt-4">
              <Image src={`${basePath}/imagenes/HEADERSOLICITUDDETAIL.svg`} alt="Header Solicitud Detail" width={800} height={100} className="w-full h-auto object-contain" data-ai-hint="company logo banner" />
