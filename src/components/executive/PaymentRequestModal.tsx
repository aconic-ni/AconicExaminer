...
export function PaymentRequestModal({ isOpen, onClose, caseData }: PaymentRequestModalProps) {
  ...
  const { setInitialContextData, openAddProductModal, setIsMemorandumMode } = useAppContext();
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Creando una solicitud para el NE: <span className="font-bold text-foreground">{caseData.ne}</span>.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
