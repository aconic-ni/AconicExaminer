...
const valueDoubtSchema = z.object({
  ...
  valueDoubtAmount: z.coerce.number().min(0.01, "El monto debe ser mayor a cero."),
  ...
  const onSubmit = async (data: ValueDoubtFormData) => {
    ...
    try {
        ...
        const updatePayload: Partial<AforoCase> = {
            ...
            valueDoubtAmount: data.valueDoubtAmount,
        ...
        if (isInitialSave) {
            ...
            logComment = `Reporte inicial de Duda de Valor con monto $${data.valueDoubtAmount}`;
        } else {
