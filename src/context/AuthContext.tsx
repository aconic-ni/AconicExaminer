  ...
  const checkUserProfile = useCallback(async (firebaseUser: FirebaseUser) => {
    ...
    if (docSnap.exists()) {
      ...
      setUser({
        ...
        hasPaymentAccess: userData.hasPaymentAccess || false, // Add this line
        visibilityGroup: userData.visibilityGroup || [], // Add this line
        canReviewUserEmails: userData.canReviewUserEmails || [], // Add this line
      });
      ...
      await setDoc(userDocRef, { 
        ...
        hasPaymentAccess: false, // Ensure new users don't have access
      }, { merge: true });
      ...
      setUser({
        ...
        roleTitle: null,
        hasReportsAccess: false,
        hasPaymentAccess: false, // Set default for new user object
      });
