...
export default function ReportsPage() {
  ...
  const fetchInitialData = async () => {
    ...
    try {
      ...
      setExams([]); // Clear visible exams until a search is performed

      // Build gestores list from fetched exams
  ...
  const filterExams = (start: Date, end: Date, gestor?: string) => {
    setError(null);
    ...
    filtered.sort((a, b) => {
        const dateA = a.completedAt || a.createdAt || a.lastUpdated || a.savedAt;
        const dateB = b.completedAt || b.createdAt || b.lastUpdated || b.savedAt;
  ...
  const handleSearch = () => {
    ...
    if (searchMode === 'range') {
      ...
      filterExams(startOfMonth, endOfMonth, selectedGestor);
    }
  };
