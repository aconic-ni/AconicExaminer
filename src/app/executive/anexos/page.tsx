...
function AnexoForm() {
  ...
  const worksheetType = (searchParams.get('type') as 'anexo_5' | 'anexo_7' | 'hoja_de_trabajo') || 'hoja_de_trabajo';
  ...
  const title = worksheetType === 'hoja_de_trabajo' ? 'Hoja de Trabajo' : worksheetType === 'anexo_5' ? 'Anexo 5' : 'Anexo 7';
