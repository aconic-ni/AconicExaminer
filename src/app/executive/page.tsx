...
export default function ExecutivePage() {
 ...
 const handleSearch = () => {
  ...
  if (selectedCaseForDocs) {
    // This is the part that needs correction.
    return (<AppShell><ManageDocumentsForm caseId={selectedCaseForDocs.id} onClose={() => setSelectedCaseForDocs(null)} /></AppShell>);
  }
