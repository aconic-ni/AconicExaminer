 ...
 const addPermit = () => {
  ...
  return (
    ...
    <Card className="w-full max-w-6xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl">Nueva Hoja de Trabajo</CardTitle>
        <CardDescription>Complete la información para generar el registro.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <div className="pt-4 border-t">
                <h3 className="text-lg font-medium mb-2">Permisos Requeridos</h3>
                 <div className="space-y-4 p-3 border rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_auto_1fr] gap-3 items-end">
                        <div className="grid gap-2">
                        ...
                        <div><Label>Estado</Label>
                         ...
                         <Button type="button" onClick={addPermit} className="self-end"><PlusCircle className="mr-2 h-4 w-4"/>Añadir</Button>
                    </div>
                 </div>
